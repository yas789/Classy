...
def add_assessment(assessment_data: dict[str, Any]) -> dict[str, Any]:
    assessment = {**assessment_data, "answers": []}
...
def get_answer(answer_id: str) -> dict[str, Any] | None:
    for assessment in ASSESSMENTS:
        answer = next((item for item in assessment["answers"] if item["id"] == answer_id), None)
        if answer:
            return answer
